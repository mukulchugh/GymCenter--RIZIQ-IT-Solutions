        ...
        <>
            ...
            <div className='fitness_margin grid grid-cols-1 items-center md:grid-cols-2 gap-8 mid-container '>
                <div className="fitness_content z-20 order-2 md:order-1">
                    ...
                    <div className=''>
                        <button className='btn btn-primary text-md w-36 font-bold'>Get Started</button>
                        <button className='btn bg-[#E5E5E5] mt-5 sm-mt-0 text-md w-36 ml-4 hover:text-white font-bold border-0 text-[#071B46]'>Preview</button>
                    </div>
                </div>
            ...
            <div className='fitness_margin z-20 grid grid-cols-1 items-center md:grid-cols-2 gap-8 mid-container'>
                <div className="fitness_image bottom_margin  bg-[#071B46] flex items-center justify-center pt-5">
                    <img className='h-[505px] z-10' src={FitnessTwoImage} alt="" />
                </div>
                <div className="fitness_content right_to_left mt-0">
                    ...
                    <div className=''>
                        <button className='btn bg-[#E5E5E5] mt-5 sm-mt-0 text-md w-36  hover:text-white ml-4 font-bold border-0 text-[#071B46]'>Preview</button>
                        <button className='btn btn-primary text-md w-36 font-bold'>Get Started</button>
                    </div>
                </div>

        ...
        <div className="bg-gray-800 border-b lg:pr-10 md:pr-4">
          <div className="mid-container">
            <div className="flex sm:justify-end justify-evenly text-white py-2">
              ...
              <Link to="/cart">
                <BsCart3 className="ml-8 hover:text-primary"></BsCart3>
              </Link>
              <Link to="#">
                <HiOutlineUser className="ml-8 hover:text-primary"></HiOutlineUser>
              </Link>
              {userRole === "accountant" && (
                <MdOutlineSpaceDashboard
                  onClick={
                    handleDashboardAccounts
                  }
              ...
              <div className="navbar-end hidden lg:flex">
                <ul className="menu menu-horizontal p-0">
                  <li className="">
                    <Link
                      to="/"
                      className="uppercase hover_effect font-semibold text-sm text-[12px] p-2 "
                      href="#"
                    >
                      Home
                    </Link>
                  ...
                  <li>
                    <CustomLink
                      to="/crossfit"
                      className=" hover_effect font-bold text-sm text-[12px] p-2"
                      href="#"
                    >
                      CrossFit
                    </CustomLink>
                  ...
                  <li>
                    <CustomLink
                      to="/programs"
                      className="uppercase hover_effect font-bold text-sm text-[12px] p-2"
                      href="#"
                    >
                      Programs
                    </CustomLink>
              ...
              <div className="navbar-end lg:hidden">
                ...
                <div className="dropdown dropdown-end ">
                  ...
                  {isOpen && (
                    <ul
                      tabIndex="0"
                      className="menu menu-compact dropdown-content mt-3 p-2 shadow  rounded-box w-52 bg-[#dbe5fa] z-50 text-black "
                    >
                      <li>
                        <Link
                          to="/"
                          className="uppercase hover_effect font-bold text-sm"
                          href="#"
                        >
                          Home
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/crossFit"
                          className=" hover_effect font-bold text-sm"
                          href="#"
                        >
                          CrossFit
                        </Link>

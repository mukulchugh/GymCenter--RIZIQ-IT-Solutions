    ...
    return (
        <div className='mid-container'>
            ...
            <div className='mb-10 grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 gap-5'>
                ...
                <div className=" rounded-2xl shadow-md p-3 text-center border">
                    <div className='flex justify-center'>
                        <img src={img1} alt="" />
                    </div>
                    <div>

                        <h2 className='text-secondary font-bold'>7:00AM To 12:30AM</h2>
                        <h2 className='text-secondary font-bold'>fb.com/CrossFitBoxDHK</h2>
                        <h2 className='text-secondary font-bold'>@CrossFitBoxDHK</h2>
                    </div>
                </div>
                <div className=" rounded-2xl shadow-md p-3 text-center border">
                    <div className='flex justify-center'>
            ...
            <div className='grid lg:grid-cols-2 md:grid-cols-2 lg:pb-16 pb-10 md:gap-10' >
